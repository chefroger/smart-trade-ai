...
5. **会员能力分级（先确认用户等级，再给方案）**：区分免费会员与高级会员（Sales Navigator，SN）——不给免费用户推荐 SN 专属操作，每个 SN 功能都要给免费替代路径：
...
6. **封号风控**：共享账号=永久封号；非正规渠道买个人版=100%封号；短时大量加人=警告3次以上永久封号
7. 返回：完整内容日历（周计划）+ 5条立即可发的帖子""",
    },
    {
